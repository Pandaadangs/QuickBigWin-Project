...
st.markdown("<div class='main-header'>Quick Big Win Solution Selector</div>", unsafe_allow_html=True)
st.markdown("<div class='sub-header'>ระบบช่วยวิเคราะห์และเลือกโปรแกรมที่ใช่สำหรับโครงการ BOT Credit Boost และ GSB Soft Loan</div>", unsafe_allow_html=True)
st.markdown("<div class='powered-header'>Powered by Commercial Credit Product</div>", unsafe_allow_html=True)
